...
export default function OfferBanner() {
  return (
    <div className=" w-full bg-[#f4f4f4] sm:flex items-end pt-16  ">
      <div className=" sm:w-1/2 flex items-end pl-5 md:pl-16 sm:pb-20">
        <div className=" ">
          ...
          <p className=" text-[#a9b5cd] cursor-default"> NEW ARIVALS JUST FOR YOU!.</p>
      ...
      <div className=" sm:px-5 sm:h-[75vh] flex items-end justify-center  ">
        <img
